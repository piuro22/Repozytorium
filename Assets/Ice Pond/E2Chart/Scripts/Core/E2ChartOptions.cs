...
namespace E2C
{
    public class E2ChartOptions : MonoBehaviour
    {
        ...
        public class Axis
        {
            ...
            [Tooltip("C# DateTime format string for min/max DateTime.")]
            public string rangeDateTimeStringFormat = "HH:mm";
            [Tooltip("The minimum DateTime range when 'autoAxisRange' is disabled.")]
            public string minDateTimeString = "00:00";
            [Tooltip("The maximum DateTime range when 'autoAxisRange' is disabled.")]
            public string maxDateTimeString = "23:59";
