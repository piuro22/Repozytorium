...
namespace E2C.ChartBuilder
{
    public class VerticalAxis : E2ChartGridAxis
    {
        ...
        public override void CreateThresholdLines()
        {
            RectTransform linesRect = E2ChartBuilderUtility.CreateEmptyRect("Threshold Lines", axisRect, true);
            linesRect.offsetMin = new Vector2(0.0f, minPadding);
            linesRect.offsetMax = new Vector2(0.0f, -maxPadding);
            thresholdLines.CreateHorizontalLines(linesRect, this);
        }
