...
namespace E2C.ChartBuilder
{
    public abstract class E2ChartBuilder
    {
        ...
        public E2ChartEvents chartEvents;
        public E2ChartThresholdLines thresholdLine;
        public Vector2 contentOffsetMin;
        public Vector2 contentOffsetMax;

        [HideInInspector] public UnityAction onBuildEnd;
        [HideInInspector] public UnityAction onUpdateTooltipText;
        ...
        public bool isDateTime { get => chartType == E2Chart.ChartType.LineChart && options.xAxis.type == E2ChartOptions.AxisType.DateTime; }
        ...
        public void Init()
        {
            ...
            thresholdLine = chart.GetComponent<E2ChartThresholdLines>();
        }
        ...
        public void Build()
        {
            ...
            if (onBuildEnd != null) onBuildEnd.Invoke();
        }
        ...
        void CreateLegends()
        {
            ...
            if (options.legend.layout == RectTransform.Axis.Horizontal)
            {
                ...
                {
                    if (rowLegendDict[row].Count == 0) continue;
