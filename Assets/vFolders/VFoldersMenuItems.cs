...
namespace VFolders
{
    class VFoldersMenuItems
    {
        ...
        [MenuItem(customIcons, false, 1)] static void dadsaadsdadsas() => customIconsEnabled = !customIconsEnabled;
        [MenuItem(customIcons, true, 1)] static bool dadsadadsdasadsas() { Menu.SetChecked(customIcons, customIconsEnabled); return true; }

        // #if UNITY_EDITOR_OSX
        //         [MenuItem(foldersFirst, false, 12)] static void dadsdsfaadsdadsas() => foldersFirstEnabled = !foldersFirstEnabled;
        //         [MenuItem(foldersFirst, true, 12)] static bool dadsasdfdadsdasadsas() { Menu.SetChecked(foldersFirst, foldersFirstEnabled); return true; }
        // #endif


        [MenuItem(menuDir + "Disable vFolders", false, 132)]
        static void das() => ToggleDefineDisabledInScript(typeof(VFolders));
        [MenuItem(menuDir + "Disable vFolders", true, 132)]
