...
{
    public SpriteRenderer cardBottonImage;
    ...
    public void Initialize(Sprite cardBottonSprite, Sprite cardTopSprite, AudioClip audioClip)
    {
        cardBottonImage.sprite = cardBottonSprite;
