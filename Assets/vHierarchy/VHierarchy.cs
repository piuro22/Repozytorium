    ...
    public static class VHierarchy
    {
        ...
        static void GameObjectRowGUI(GameObject go, Rect rowRect)
        {
            ...
            void drawIcon()
            {
                ...
                void iconBackground()
                {
                    ...
                    var selected = new Color(.2f, .37f, .57f);
                    var selectedUnfocused = Greyscale(.3f);
                    var hovered = Greyscale(.28f);
            ...
            void componentMinimap()
            {
                ...
                void button(Rect rect, Component component)
                {
                    ...
                    void draw()
                    {
                        ...
                        SetGUIColor(Greyscale(1, mouseRect.IsHovered() && holdingAlt ? 1 : .33f));
        ...
        static void SceneRowGUI(Scene scene, Rect rowRect)
        {
            ...
            void lighting()
            {
                ...
                SetGUIColor(buttonRect.IsHovered() ? Color.white : Greyscale(.9f));
            ...
            void collapseEverything()
            {
                ...
                SetGUIColor(buttonRect.IsHovered() ? Color.white : Greyscale(.85f));
        ...
        static void Init()
        {
            void loadData()
            {
                string defaultDataPath = "Assets/vHierarchy/vHierarchy Data.asset";                                                          // TOCHANGE

                data = AssetDatabase.LoadAssetAtPath<VHierarchyData>(EditorPrefs.GetString("vHierarchy-dataPath", defaultDataPath));
                if (data) return;
                ...
                if (data) { EditorPrefs.SetString("vHierarchy-dataPath", data.GetPath()); return; }
        ...
        static EditorWindow hierarchyWindow => Resources.FindObjectsOfTypeAll(t_SceneHierarchyWindow).FirstOrDefault() as EditorWindow;
