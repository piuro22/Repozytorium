...
namespace RenderHeads.Media.AVProVideo
{
	...
	{
		public const string AVProVideoVersion = "2.8.4";
		public sealed class ExpectedPluginVersion
		{
			public const string Windows      = "2.8.3";
			public const string WinRT        = "2.8.3";
			public const string Android      = "2.8.3";
			public const string Apple        = "2.8.3";
		}
